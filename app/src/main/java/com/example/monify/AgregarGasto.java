...
public class AgregarGasto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_gasto); // Usa el mismo layout
        ...
        // Configurar el botón para agregar el gasto
        btnAgregarGasto.setOnClickListener(v -> {
            String montoStr = edtMonto.getText().toString();
            if (montoStr.isEmpty() || tarjetaSeleccionadaId == -1) {
                Toast.makeText(AgregarGasto.this, "Por favor selecciona una tarjeta y un monto.", Toast.LENGTH_SHORT).show();
                return;
            }

            double monto = Double.parseDouble(montoStr);

            // Crear una nueva transacción para un gasto
            ...
            // Actualizar el saldo de la tarjeta (restando el monto)
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ArrayAdapter<Tarjeta> adapter = new ArrayAdapter<>(AgregarGasto.this, android.R.layout.simple_spinner_item, tarjetas);
    ...
    private void insertTransaccion(Transaccion transaccion) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                // Obtener el DAO de la transacción
    ...
    private void actualizarSaldoTarjeta(int tarjetaId, double monto) {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (tarjeta != null) {
                    // Restar el monto al saldo de la tarjeta para el gasto
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(AgregarGasto.this, "Saldo actualizado exitosamente", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
